        ...
        <div class="card-body">
            ...
            <div class="card border">
                ...
                <form class="form-inline my-2 my-lg-0" method="GET" action="/despesas/lancamentos/filtro">
                    ...
                    <div class="input-group mb-3">
                        <input class="form-control mr-sm-2" type="number" placeholder="Código" name="codigo">
                        <input class="form-control mr-sm-2" type="text" placeholder="Descrição" name="descricao">
            ...
            <div class="table-responsive-xl">
                ...
                @php
                    $data = date("Y-m-d");
                @endphp
                    <a class="fill-div" data-toggle="modal" data-target="#exampleModal{{$despesa->id}}"><div id="my-div" class="bd-callout @if($despesa->pago==1) bd-callout-success @else @if($despesa->vencimento<$data) bd-callout-danger @endif bd-callout-info @endif">
                ...
                <form method="POST" action="/despesas/lancamentos">
                    ...
                    <div class="form-group">
                        ...
                        <div id="principalSelect">
                            ...
                            <input type="text" class="form-control" name="valorParcela" id="valorParcela" placeholder="Exemplo: 35.5" required></label>
                            </div>
                            <div id="0">
                            </div>
                        </div>    

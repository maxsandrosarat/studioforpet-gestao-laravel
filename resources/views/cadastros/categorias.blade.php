                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($cat->ativo==1)
                                <a href="/categorias/apagar/{{$cat->id}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-placement="right" title="Inativar"><i class="material-icons md-48 red">disabled_by_default</i></a>
                            @else
                                <a href="/categorias/apagar/{{$cat->id}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-placement="right" title="Ativar"><i class="material-icons md-48 green">check_box</i></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach

                                    ...
                                    <div class="modal-body">
                                        <div class="card-body">
                                            <form method="POST" action="/cliente/editar/{{$cliente->id}}">
                                                ...
                                                <div>
                                                    <input id="cpf" type="text" class="form-control @error('cpf') is-invalid @enderror" name="cpf" autocomplete="cpf" autofocus value="{{$cliente->cpf}}" onblur="formatarCpf()">
                                                ...
                                                <label>CEP
                                                <input class="form-control" name="cep" type="number" id="cep" value="{{$cliente->cep}}" size="10" maxlength="9"
                                                onblur="pesquisacep(this.value);" /></label><br />
                                                <label>Rua:
                                                <input class="form-control" name="rua" type="text" id="rua" size="60" value="{{$cliente->rua}}"/></label><br />
                                                <label>Bairro:
                                                <input class="form-control" name="bairro" type="text" id="bairro" size="40" value="{{$cliente->bairro}}"/></label><br />
                                                <label>Cidade:
                                                <input class="form-control" name="cidade" type="text" id="cidade" size="40" value="{{$cliente->cidade}}" /></label><br />
                                                <label>Estado:
                                                <input class="form-control" name="uf" type="text" id="uf" size="2" value="{{$cliente->uf}}"/></label><br />
                                                <input class="form-control" name="ibge" type="hidden" id="ibge" size="8" />
                                                <label for="numero">Número</label>
                                                <input class="form-control" type="number" name="numero" id="numero" size="5" value="{{$cliente->numero}}"><br>
                                                <label for="complemento">Complemento</label>
                                                <input class="form-control" type="text" name="complemento" id="complemento" size="60" value="{{$cliente->complemento}}">
                                                <br/>
